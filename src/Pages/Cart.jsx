    ...
    <div className="h-16 w-16 flex items-center bg-cover">
      ...
      <div className='flex flex-col md:flex-row justify-between'>
        <div className='w-full md:w-[60%]'>
          ...
          <p>Product details :</p>
          <p>You have 4 products in your cart</p>
          </div>
        ...
        <table>
          ...
          <tbody className='text-gray-400'>
            <tr className='grid grid-cols-7 gap-4 my-2 text-[12px]'>
              <td className='text-center'>1.</td>
              <td className='col-span-3 flex flex-col md:flex-row justify-around gap-2'>
              <h2 className='text-center text-[16px]'>coffee</h2>
                <img src="../coffee.jpg" alt="" className='w-[170px] h-[170px] bg-cover'/>
              </td>
      ...
      <div className='px-5 py-2 mt-10 h-[450px] bg-slate-200 w-full md:w-[35%] rounded-lg'>
        ...
        <form>
          ...
          <div className='flex justify-between mb-3'>
            <h2>Subtotal</h2><p>$456</p>
          </div>
          <div className='flex justify-between mb-3'>
            <h2>Shipping</h2><p>$456</p>
          </div>
          <div className='flex justify-between mb-3'>
            <h2>Total(Inc.taxes)</h2><p>$456</p>
          </div>
